...
See <<doc/setup-mqm-ha.adoc#,Setup Home Assistant & mqmgateway>> for step-by-step instructions on integration of a Modbus device into Home Assistant via MQTT.
